...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', # Usa 'django.db.backends.postgresql' para PostgreSQL y 'django.db.backends.mysql' para MySQL
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# Introduce aquí la dirección de Gmail que usará la aplicación para enviar correos.
